...
# Define a black_box_function specific to LightGBM
def black_box_function(n_estimators, max_depth, num_leaves, min_child_weight, subsample, colsample_bytree, reg_alpha):
...
pbounds = {
    ...
    "max_depth": (1, 15),  # Range for max_depth
    "num_leaves": (20, 150),  # Range for num_leaves
    "min_child_weight": (0.001, 10),  # Range for min_child_weight
