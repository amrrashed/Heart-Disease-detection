...
from sklearn.tree import DecisionTreeClassifier  # Change this import
...
# Bayesian Optimization function for Decision Tree parameters
def dt_optimization(max_depth, min_samples_split, min_samples_leaf):
    # Define Decision Tree model with specified parameters
...
optimizer = BayesianOptimization(f=dt_optimization, pbounds=pbounds, random_state=1)
...
best_model = DecisionTreeClassifier(max_depth=int(best_params['max_depth']),
